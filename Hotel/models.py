...
class RoomCategory(models.Model):
    hotel = models.ForeignKey(Hotel, related_name='categories', on_delete=models.CASCADE)
    title = models.CharField(max_length=100)
    base_price = models.DecimalField(max_digits=10, decimal_places=2)
    capacity_adults = models.PositiveIntegerField()
    capacity_child = models.PositiveIntegerField()
    description = models.TextField()
    features = models.ManyToManyField(RoomFeature, related_name='categories', blank=True)
